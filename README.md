...
| [doc-dedup-check](skills/doc-dedup-check/SKILL.md) | Prevent documentation duplication when creating or expanding .md files — scans the project for overlapping content and designates a single source of truth |
